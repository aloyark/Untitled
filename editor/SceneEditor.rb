class SceneEditor
	...
	def initialize
		...
		@sel_16_y = 112
		#32-bit
		@sel_32 = Image.new($window, "editor/sel32.png", false)
		@sel_32_x = 672
		@sel_32_y = 112
		...
		@objects = []
		@player_graphic = Image.load_tiles($window, "graphics/sprites/player_right.png", 32, 32, false)
		@active_mode = :map
		@object_held = nil
